...
This cookbook is an initiative of the `PID4NFDI project <https://pid.services.base4nfdi.de/>`_ to set up a basic service for Persistent Identifiers (PID) for the member consortia of the German `National Research Data Infrastructure (NFDI) <https://www.nfdi.de/?lang=en>`_ - a joint project of research and infrastructure institutions to optimise research data management within the German research landscape.
