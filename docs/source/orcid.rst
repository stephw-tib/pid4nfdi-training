...
The `ORCID Help Center <https://support.orcid.org/hc/en-us>`_ provides information for contributors on how to manage your ORCID record, e.g.:
  ...
  *  How should the ORCID iD be displayed? `ORCID Brand Guidelines <https://info.orcid.org/brand-guidelines/>`_ 
...
----------------------------------
  * `Webinar Series <https://info.orcid.org/orcid-on-demand/>`_ on trends and emerging solutions
