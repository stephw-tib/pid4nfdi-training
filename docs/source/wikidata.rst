...
Wikidata ID vs. Wikidata IRI
While the short identifier (e.g. Q42) is commonly used in user interfaces, the canonical machine-actionable form is the Wikidata IRI (https://www.wikidata.org/entity/Q42). This IRI is resolvable, globally unique, and suitable for use in Linked Data and semantic web contexts.
